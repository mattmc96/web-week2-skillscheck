...
// Code Here
var groceries = ["coffee", "apples", "chocolate"];
...
const setGroceryListTitle = (x) => {
  return ` ${x}'s Groceries`;
};
//////////////////STEP 4////////////////////
//Create a function called 'addItem' that takes in one parameter called 'item'. Add the item parameter to the end of the
//groceries array created above. Inside of addItem, invoke displayData() which is a function you did not create
...
//  groceries is greater than or equal to 5. If it is, return the string 'That looks like a big trip' from the
//  function. If the number of groceries is equal to one, return the string '1 item'. If the amount of groceries
